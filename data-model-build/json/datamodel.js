let datamodel = {
  ...
  "InsurancePolicy": {
    "type": "object",
    "documentation": {
      "en": "Represent an Insurance product."
    },
    "properties": {
      "coverages": {
        "type": "List",
        "of": "Coverage",
        "documentation": {
          "en": "A product contain one or multiple coverage, describing what is the insurer promise in what situation"
        }
      },
      "riskObjects": {
        "type": "List",
        "of": "RiskObject",
        "documentation": {
          "en": "Risk objects describe what specific things are insured in the contract."
        }
      },
      "specifics": {
        "type": "List",
        "of": "Specific",
        "documentation": {
          "en": "The specific named values that have been underwritten in the product. Ex : InsuredHomeValue"
        }
      }
    }
  },
  ...
  "UnitDimensionEnum": {
    ...
    "values": {
      ...
      "mass": {
        "documentation": "A mass"
      },
      "person": {
        "documentation": "An amount of person"
      }
    }
  },
  "UnitDistanceEnum": {
    ...
    "values": {
      "meter": {
        "primaryKey": "meter",
        "conversion": 1,
        "displayName.en": "meter",
        "shortNotation.en": "m"
      },
      "decimeter": {
        "primaryKey": "decimeter",
        "conversion": 0.1,
        "displayName.en": "decimeter",
        "shortNotation.en": "dm"
      },
      "centimeter": {
        "primaryKey": "centimeter",
        "conversion": 0.01,
        "displayName.en": "centimeter",
        "shortNotation.en": "cm"
      },
      "millimeter": {
        "primaryKey": "millimeter",
        "conversion": 0.001,
        "displayName.en": "millimeter",
        "shortNotation.en": "mm"
      },
      "decameter": {
        "primaryKey": "decameter",
        "conversion": 10,
        "displayName.en": "decameter",
        "shortNotation.en": "dam"
      },
      "hectometer": {
        "primaryKey": "hectometer",
        "conversion": 100,
        "displayName.en": "hectometer",
        "shortNotation.en": "hm"
      },
      "kilometer": {
        "primaryKey": "kilometer",
        "conversion": 1000,
        "displayName.en": "kilometer",
        "shortNotation.en": "km"
      },
      "yard": {
        "primaryKey": "yard",
      ...
      "miles": {
        "primaryKey": "miles",
        "conversion": 1609.34,
        "displayName.en": "miles",
        "shortNotation.en": "mi"
      },
      "nauticalMiles": {
        "primaryKey": "nauticalMiles",
        "conversion": 1852,
        "displayName.en": "nautical miles",
        "shortNotation.en": "NM"
      },
      "foot": {
        "primaryKey": "foot",
  ...
  "UnitTimeEnum": {
    ...
    "values": {
      "second": {
        "primaryKey": "second",
        "displayName.en": "second"
      },
      "millisecond": {
        "primaryKey": "millisecond",
        "displayName.en": "millisecond"
      },
      "minute": {
        "primaryKey": "minute",
        "displayName.en": "minute"
      },
      "hour": {
        "primaryKey": "hour",
        "displayName.en": "hour"
  ...
  "date": {
    "type": "system",
    "documentation": "A date value in ISO 8601 date format."
  },
  "dateTime": {
    "type": "system",
    "documentation": "A combination of date and time of day in the form [-]CCYY-MM-DDThh:mm:ss[Z|(+|-)hh:mm] (see Chapter 5.4 of ISO 8601)."
  },
  "number": {
    "type": "system",
  ...
  "time": {
    "type": "system",
    "documentation": "A point in time recurring on multiple days in the form hh:mm:ss[Z|(+|-)hh:mm] (see XML schema for details)."
  }
}